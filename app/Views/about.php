            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-4">
                    ...
                    <ul class="text-muted mb-0 ps-3">
                        <li>Menyediakan informasi yang cepat dan akurat</li>
                        <li>Membangun komunikasi yang efektif dengan masyarakat</li>
                        <li>Mempromosikan potensi dan perkembangan Sinjai</li>
                        <li>Mendukung transparansi pemerintahan</li>
                    </ul>
                </div>
            </div>
        </div>
