...
<?= $this->section('page_title') ?>Edit Profil<?= $this->endSection() ?>
    ...
    <div class="col-lg-12">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-transparent border-bottom-0 py-4">
                ...
                <p class="text-muted mb-0 mt-2">Edit informasi profil</p>
            </div>

            <div class="card-body">
                <form action="<?= base_url('admin/profiles/' . $profile['id']) ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12" id="image-container">
                            <div class="form-group">
                                ...
                                <img id="image-preview" src="<?= !empty($profile['image']) ? esc($profile['image']) : '' ?>" class="img-fluid rounded mt-2 shadow-sm" style="max-height: 200px; display: <?= !empty($profile['image']) ? 'block' : 'none' ?>;">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="position" id="position" class="form-control form-control-lg border-0 bg-light rounded-3 py-3 <?= (isset(session('errors')['position'])) ? 'is-invalid' : '' ?>"
                                    value="<?= old('position', $profile['position']) ?>" placeholder="Contoh: Bupati Sinjai, Anggota DPRD...">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="institution" id="institution" class="form-control form-control-lg border-0 bg-light rounded-3 py-3 <?= (isset(session('errors')['institution'])) ? 'is-invalid' : '' ?>"
                                    value="<?= old('institution', $profile['institution'] ?? '') ?>" placeholder="Contoh: Polres Sinjai, Kejari Sinjai...">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="order" id="order" class="form-control form-control-lg border-0 bg-light rounded-3 py-3 <?= (isset(session('errors')['order'])) ? 'is-invalid' : '' ?>"
                                    value="<?= old('order', $profile['order']) ?>" placeholder="0">
                        ...
                        <div class="col-12" id="bio-container">
                            <div class="form-group">
                                ...
                                <textarea name="bio" id="bio" class="form-control border-0 bg-light rounded-3 <?= (isset(session('errors')['bio'])) ? 'is-invalid' : '' ?>" rows="6"
                                    placeholder="Tulis biografi singkat..."><?= old('bio', $profile['bio']) ?></textarea>
